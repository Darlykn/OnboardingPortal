...
### 1. Вход и связь с наставником

**Сценарий:** авторизация → переход к наставнику.

- Просмотр прогресса на главной странице
- Переход к наставнику через блок «Быстрый доступ»
- Автоматический переход в раздел «Помощь» (наставник выделен)
...
**Сценарий:** выполнение задач онбординга.

- Просмотр задач по этапам
- Отметка выполнения (must / should / nice)
...
**Сценарий:** изучение процессов отдела.
