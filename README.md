...
### 1. Авторизация и связь с наставником

- Авторизация по логину и паролю
- Просмотр прогресса на главной странице
- Переход к наставнику через блок «Быстрый доступ»
- Автоматический переход в раздел «Помощь» (назначенный наставник выделен)
- Копирование шаблона и отправка письма

![Вход и связь с наставником](docs/login-email.gif)

### 2. Чек-лист адаптации

- Просмотр задач по этапам
- Оценка приоритета задачи
- Отметка задачи как выполненной 
- Снятие отметки при необходимости
- Автоматическое обновление прогресса на главной странице 

![Чек-лист адаптации](docs/tasks.gif)

### 3. Карта процессов отдела

- Выбор этапа
- Ознакомление с описанием, артефактами 

![Карта процессов](docs/process.gif)
